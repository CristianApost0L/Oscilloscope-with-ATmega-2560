...
//Inizializzazione dell'allocatore che deve gestire una free_list necessaria per conoscere 
//sempre il primo blocco disponibile da poter restituire e un buffer di memoria.
//La free_list viene inizializzata con parte della memory_block data in input.
...
//Vieni restituito il primo blocco disponibile,il cui indirizzo di memoria di buffer viene gestito 
//dall'allocatore grazie alla posizione salvata in first_indx
...
//Rilascia il blocco di memoria block, accertandosi prima che sia un multiplo di item_size, ovvero
//l'inidirizzo di testa di un blocco di buffer valido
