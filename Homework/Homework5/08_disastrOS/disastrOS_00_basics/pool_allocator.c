...
PoolAllocatorResult PoolAllocator_init(PoolAllocator* a,
  ...
  // item|item|item|......|n|n|n|..... the firsts adresses between memory_block and memory_block+item_size*num_items are the slaps 
  //the other adresses until memory_block+item_size*num_items+num_items are use for the free_list
